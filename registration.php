...
include('includes/config.php');
  ...
  if (isset($_POST['submit'])) {
    ...
    $ret = mysqli_query($bd, "insert into students(studentName,StudentRegno,password,pincode,course) values('$studentname','$studentregno','$password','$pincode','$course')");
    $reg = mysqli_query($bd, "insert into courseenrolls(studentRegno,course) values('$studentregno','$course') ");
    if ($ret && $reg) {
            ...
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                <form name="dept" method="post">
                  ...
                  <button type="submit" name="submit" id="submit" class="btn btn-default">Sign Up</button>
